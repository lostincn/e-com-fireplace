    ...
    <Container>
      ...
      <Wrapper>
        ...
        <Top>
          ...
          <TopButton type="filled">Рассчитать стоимость</TopButton>
        </Top>
        <Bottom>
          <Info>
            <Product>
              <ProductDetail>
                ...
                <Details>
                  <ProductName>
                    <b>Продукт:</b> JESSIE THUNDER SHOES
                  </ProductName>
                  <ProductId>
                    <b>ID:</b> 93813718293
                  </ProductId>
          ...
          <Summary>
            <SummaryTitle>Ваша корзина</SummaryTitle>
            <SummaryItem>
            ...
            <SummaryItem type="total">
              <SummaryItemText>Общая стоимость</SummaryItemText>
              <SummaryItemPrice>$ 80</SummaryItemPrice>
            </SummaryItem>
